...
def build_model(hp):
    ...
    lr = hp.Choice('lr', [0.05,0.01,0.005,0.001,0.0005,0.0001,0.00005,0.00001,0.000005,0.000001], default=0.00005)
...
class MyTuner(kt.Hyperband):
    def run_trial(self, trial, *args, **kwargs):
        ...
        kwargs['batch_size'] = trial.hyperparameters.Choice(
            'batch_size', [8,16,32,64], default=16)
        list(args)
