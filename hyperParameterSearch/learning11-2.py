...
def build_model(hp):
    ...
    a_1 = hp.Choice('a_1', ['linear' , 'relu'])
    x = Dense(100, activation=a_1, name="Combined_Hidden_Layer_1")(x)
    a_2 = hp.Choice('a_2', ['linear' , 'relu'])
    x = Dense(100, activation=a_2, name="Combined_Hidden_Layer_2")(x)
    a_3 = hp.Choice('a_3', ['linear' , 'relu'])
    x = Dense(100, activation=a_3, name="Combined_Hidden_Layer_3")(x)
...
tuner = MyTuner(
    ...
    project_name='15112020_t10-4-activation')
